...
const confirmMessages = {
  pending: {
    description:
      "Are you sure you want to delete this gate entry? Once deleted, it cannot be restored.",
  },
  success: {
...
export function RowActions({ row, table }) {
  ...
  try {
    await axios.delete(`/gateentry/gate-entry-delete/${id}`);
    ...
    setDeleteError(true);
     toast.error("Failed to delete gate entry ❌", {
      duration: 2000,
    });
  } finally {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center gap-2">
        {/* Edit Button */}
        <Link
          to={`/dashboards/gate-entry/gate-entry/edit/${row.original.id}`}
