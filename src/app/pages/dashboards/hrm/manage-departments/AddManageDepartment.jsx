...
export default function AddManageBranch() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("/hrm/add-department", form); // token attached via interceptor

      toast.success("Manage Department created successfully ✅", {
        duration: 1000,
        icon: "✅",
      });
  ...
  return (
    <Page title="Add Manage Department">
      <div className="p-6">
        {/* Header + Back Button */}
