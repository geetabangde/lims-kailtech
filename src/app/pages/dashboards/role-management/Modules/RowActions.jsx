...
const confirmMessages = {
  pending: {
    description:
      "Are you sure you want to delete this Module? Once deleted, it cannot be restored.",
  },
  success: {
...
export function RowActions({ row, table }) {
  ...
  try {
    await axios.delete(`/roles/delete-module/${id}`);
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center gap-2">
        {/* Edit Button */}
        {permissions.includes(118) && (
          <Link
            to={`/dashboards/role-management/modules/edit/${row.original.id}`}
