...
const confirmMessages = {
  pending: {
    description:
      "Are you sure you want to delete this test clause? Once deleted, it cannot be restored.",
  },
  success: {
    title: "Test Clause Deleted",
  },
};
...
export function RowActions({ row, table }) {
  ...
  const handleDeleteRows = useCallback(async () => {
    ...
    try {
      ...
      toast.success("Test Clause deleted successfully ✅", {
        duration: 1000,
        icon: "🗑️",
      });
  ...
  return (
    <>
      <div className="flex justify-center items-center space-x-2">
        {/* Edit Button */}
        <Link
          to={`/dashboards/testing/test-clauses/edit/${id}`}
